...
public class BSalygos {
    ...
    public static void main(String[] args) {
        ...
        * */
            ...
            * */
            ...
            switch (zodis) {
                case "juoda": System.out.println("juoda");
                    break;
                case "avis": System.out.println("default");
                    break;
            }

            if (zodis.equals("juoda")) {
                System.out.println("juoda");
            }else if (zodis.equals("avis")){
        ...
        int b = input.nextInt();
        switch (b){
            case 3: System.out.println("Ivestas trejetas, ivestas ketvertas, ivestas penketas");
                break;
            case 8: System.out.println("Ivestas astuonetas, ivestas devynetas");
                break;
             default: System.out.println("Ivestas neigiamas skaicius");
